    ...
    <div className='relative col-span-3 sm:col-span-2 lg:col-span-1'>
      ...
      <div className='relative'>
        ...
        <button
          ...
          className="text-left mh-input p-2.5 pr-8 w-full text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
          type="text"
          onClick={handledDropdownSearch}
      ...
      {visibleDropdownList && (
        <div
          ...
          <ul className="overflow-y-auto py-2 text-sm text-gray-700 dark:text-gray-400">
            {
              properties.DataSource.map((type) => {
                return (
                  <li
                    key={type.value}
                    onClick={() => { handledItemSelected(type.value, type.textValue) }}
